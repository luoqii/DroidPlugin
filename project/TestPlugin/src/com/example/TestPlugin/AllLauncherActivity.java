        ...
        void fillData(ListView view){
            ...
            ArrayAdapter<ResolveInfo> adapter = new ArrayAdapter<ResolveInfo>(getActivity(), 0, acts){
                ...
                public View getView(int position, View convertView, ViewGroup parent) {
                    ...
                    String packageName = r.activityInfo.applicationInfo.className;
                    packageName = "";
                    if (TextUtils.isEmpty(packageName)){
                        packageName = r.activityInfo.applicationInfo.packageName;
                    }
                    packageName += " " + mPm.getApplicationLabel(r.activityInfo.applicationInfo);
                    ((TextView)v.getChildAt(1)).setText(packageName);
